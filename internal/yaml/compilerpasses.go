...
type CompilerPass struct {
	...
	ExtractK8ResourceName    *ExtractK8ResourceName    `yaml:"extract_k8_resource_name"`
...
func (pass CompilerPass) AsCompilerPass() (compiler.Pass, error) {
	...
	if pass.ExtractK8ResourceName != nil {
		return pass.ExtractK8ResourceName.AsCompilerPass()
	}
...
type ExtractK8ResourceName struct{}

func (pass ExtractK8ResourceName) AsCompilerPass() (*compiler.ExtractK8sResourceName, error) {
	return &compiler.ExtractK8sResourceName{}, nil
}
