...
func TestBuilder_Generate(t *testing.T) {
	test := testutils.GoldenFilesTestSuite[languages.Context]{
		...
		Skip: map[string]string{
			...
			"constant_assignment":               "out of scope for Phase 4a",
			"constraints":                       "constraints-as-guards out of scope for Phase 4a",
			"dashboard_panel":                   "out of scope for Phase 4a",
			"dataquery_variant_builder":         "variants out of scope for Phase 4a",
			"discriminator_without_option":      "out of scope for Phase 4a",
			...
			"known_any":                         "out of scope for Phase 4a",
