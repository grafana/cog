...
import {
    PanelBuilder,
    QueryGroupBuilder, TargetBuilder,
  ...
  node_memory_Cached_bytes{job="integrations/raspberrypi-node", instance="$instance"}
    ...
    return new PanelBuilder()
        ...
        .data(new QueryGroupBuilder().targets([
            ...
            new TargetBuilder().query(basicPrometheusQuery(`node_memory_Buffers_bytes{job="integrations/raspberrypi-node", instance="$instance"}`, "Buffers")),
            new TargetBuilder().query(basicPrometheusQuery(`node_memory_Cached_bytes{job="integrations/raspberrypi-node", instance="$instance"}`, "Cached")),
            new TargetBuilder().query(basicPrometheusQuery(`node_memory_MemFree_bytes{job="integrations/raspberrypi-node", instance="$instance"}`, "Free")),
        ]));
};
    ...
    return new PanelBuilder()
        ...
        .data(
            new QueryGroupBuilder()
                .target(new TargetBuilder().query(basicPrometheusQuery(query, "")))
        );
};
