...
var _ Transform = (*DisjunctionWithConstantToDefault)(nil)

type DisjunctionWithConstantToDefault struct {
}

func (pass *DisjunctionWithConstantToDefault) Process(schemas ir.Schemas) (ir.Schemas, error) {
	visitor := &Visitor{
...
func (pass *DisjunctionWithConstantToDefault) processDisjunction(_ *Visitor, _ *ir.Schema, def ir.Type) (ir.Type, error) {
