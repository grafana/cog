...
func (refs ObjectReferences) Matches(object ir.Object) bool {
...
func (ref ObjectReference) Matches(object ir.Object) bool {
	return ref.MatchesRef(object.SelfRef)
}

func (ref ObjectReference) MatchesRef(refType ir.RefType) bool {
	return refType.ReferredPkg == ref.Package && strings.EqualFold(refType.ReferredType, ref.Object)
}

func (ref ObjectReference) AsRef() ir.RefType {
	return ir.RefType{
...
func (ref FieldReference) Matches(object ir.Object, field ir.StructField) bool {
