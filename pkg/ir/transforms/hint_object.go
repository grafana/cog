...
var _ Transform = (*HintObject)(nil)
...
func (pass *HintObject) Process(schemas ir.Schemas) (ir.Schemas, error) {
...
func (pass *HintObject) processObject(_ *Visitor, _ *ir.Schema, object ir.Object) (ir.Object, error) {
