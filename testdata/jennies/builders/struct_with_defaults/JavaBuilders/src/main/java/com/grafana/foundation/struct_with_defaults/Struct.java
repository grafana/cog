...
public class Struct {
    ...
    public Builder setAllFields(com.grafana.foundation.cog.Builder<NestedStruct> allFields) {
    this.internal.allFields = allFields.build();
        return this;
    }
    
    public Builder setPartialFields(com.grafana.foundation.cog.Builder<NestedStruct> partialFields) {
    this.internal.partialFields = partialFields.build();
        return this;
    }
    
    public Builder setEmptyFields(com.grafana.foundation.cog.Builder<NestedStruct> emptyFields) {
