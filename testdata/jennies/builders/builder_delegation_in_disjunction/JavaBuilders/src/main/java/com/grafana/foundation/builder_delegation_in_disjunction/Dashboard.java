...
public class Dashboard {
    ...
    public Builder setSingleLinkOrString(com.grafana.foundation.cog.Builder<unknown> singleLinkOrString) {
    this.internal.singleLinkOrString = singleLinkOrString.build();
        return this;
    }
    
    public Builder setLinksOrStrings(com.grafana.foundation.cog.Builder<List<unknown>> linksOrStrings) {
    this.internal.linksOrStrings = linksOrStrings.build();
        return this;
    }
    
    public Builder setDisjunctionOfBuilders(com.grafana.foundation.cog.Builder<unknown> disjunctionOfBuilders) {
