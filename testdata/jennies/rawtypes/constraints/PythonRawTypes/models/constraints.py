...
class SomeStruct:
    ...
    def __init__(self, id_val: int = 0, maybe_id: typing.Optional[int] = None, greater_than_zero: int = 0, title: str = "", labels: typing.Optional[dict[str, str]] = None, tags: typing.Optional[list[str]] = None) -> None:
        self.id_val = id_val
